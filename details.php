	...
	<body style="background-image: url('images/bg.jpeg');">
		<div class="top_wrapper">		
			...
			<div class="header_wrapper" align="center">
				...
				<a href="index.php" style="float:left;"> <img id="logo" src="images/logo3.png" /> </a>
			...
			<div class="menubar">
				<ul id="menu">
					...
					<li><a href="https://indian-recommendation-system.herokuapp.com/">Recommendation Place</a></li>
				</ul>
			</div>
		...
		<div class="main_wrapper">
			...
			<div class="content_wrapper">
				...
				<br>
				<br>
				If you would like to visit art & cultural monuments Places of India <br>
				then click below and get some recommended places..

				<br>
				<br><a href="https://indian-recommendation-system.herokuapp.com/">Recommendation Place</a></li>						
				</div>
			</div>
			...
			<h2 style="text-align:center;padding-top:10px;">&copy; 	</h2>
